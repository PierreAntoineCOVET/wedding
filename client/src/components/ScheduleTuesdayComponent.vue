<template>
  <h5>Mardi 5 août 2025</h5>

  <p>14h15 : Rendez-vous à la Marie de Goncelin (38), ou sera célébré notre mariage civile à 14h30.</p>

  <p>(Soyez à l’heure, ça serait dommage de rater l’instant officiel !)</p>

  <p>Pour vous garer plusieurs parkings sont disponibles.</p>
  ...
  <p>15h30 : Départ pour le lieu de réception : Le domaine de la Pierre à Sel (73)</p>

  <p>16h30 : Arrivée et installation sur le lieu de réception (le temps de trajet est estimé à 45 minutes depuis la Mairie)</p>
  ...
  <p>Le trajet est de 43 minutes est le plus simple pour l’accès sur le site. Celui de 44 minutes vous permettra d’apprécier la vue de la vallée et des gorges d’Allevard avant de prendre la direction de la Vallée des Huiles.</p>

  <p>Le lieu : Domaine de la Pierre à Sel : </p>

  <p>17h30 : On prend la pose ! Vous n’aimez pas les photos, tant pis, c’est comme Dorian vous n’aurez pas vraiment le choix ! Faudrait pas contrarier la mariée quand même, elle adore les photos (des autres) !</p>

  <p>18h45 : Si vous êtes sages pendant les photos, possible qu’on vous offre l’apéritif !</p>

  <p>20h00 : L’heure du diner ! Faites vos jeux ! Vous avez un choix cornélien à faire (ici sur le site) entre un plat à base de fromage et de vin (oui vous avez bien compris qu’il s’agit d’une fondue savoyarde mais on fait semblant de garder la surprise) OU un mélange de viandes (là c’est plus dur à deviner – mix de viandes à la plancha).</p>
